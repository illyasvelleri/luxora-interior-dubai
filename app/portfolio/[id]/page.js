    ...
    return (
      <main className="bg-[#0d0d0d] min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-serif text-[#e8e8e8] mb-4">Project Not Found</h1>
          <Link href="/portfolio" className="text-[#d4af37] hover:underline">
            Return to Portfolio
          </Link>
        </div>
      </main>
    ...
    <main className="bg-[#0d0d0d] text-[#e8e8e8] min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0d0d0d]/95 backdrop-blur-sm border-b border-[#1a1a1a]">
        <div className="max-w-[1800px] mx-auto px-6 sm:px-8 lg:px-20 py-6 sm:py-8 flex items-center justify-between">
          <Link href="/" className="text-lg sm:text-xl tracking-[0.4em] font-light hover:text-[#d4af37] transition-colors">
            LUMINA
          </Link>
          <Link href="/portfolio" className="text-xs tracking-[0.25em] text-[#d0d0d0] hover:text-[#d4af37] transition-colors">
            BACK TO PORTFOLIO
          </Link>
        </div>
      </nav>
