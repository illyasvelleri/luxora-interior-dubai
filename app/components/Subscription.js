...
export default function Subscription() {
  return (
    <section className="relative py-20 sm:py-24 md:py-32 bg-[#0a0a0a] border-t border-[#1a1a1a] overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0">
        <Image
          src="/hero-01.png" // replace with your image
          alt="Subscription Background"
          fill
          className="object-cover opacity-30 blur-[8px]"
          priority
        />
      </div>

      {/* Content */}
      <div className="relative max-w-[800px] mx-auto px-6 sm:px-8 text-center">
        <div className="text-xs tracking-[0.3em] text-[#888] mb-4 sm:mb-6">
          STUDIO COMMUNICATIONS
        </div>
        <h3 className="font-serif text-2xl sm:text-3xl md:text-4xl mb-4 sm:mb-6 tracking-tight">
